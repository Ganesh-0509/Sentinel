    ...
    <div className="panel flex h-full flex-col">
      <div className="panel-header">
        ...
        <button
          onClick={run}
          disabled={!zone || busy}
          className="rounded bg-sky-600 px-3 py-1 text-[11px] font-medium text-white transition hover:bg-sky-500 disabled:cursor-not-allowed disabled:opacity-40"
        >
        ...
        {result && (
          <div className="space-y-4">
            <section>
              ...
              <ol className="space-y-1 font-mono text-[10.5px] text-slate-400">
            ...
            {result.permit_decision && (
              <section>
                ...
                {result.permit_decision.citations.map((c, i) => (
                  <p key={i} className="mt-1 text-[10px] text-sky-300/80">[cite] {c}</p>
                ))}
              </section>
            )}
